...
show_usage() {
    ...
    echo "  --density-averaging [STEP] Enable density averaging after given step (default: 10000 if not specified)"
...
build_simulation_command() {
    ...
    local cmd="./lattice2D-Lea-improved --density $density --tumble-rate $tumble_rate --total-time $total_time --run-name $run_name"
...
echo "Compiling lattice2D-Lea-improved with optimizations..."
gcc -O3 -march=native -ffast-math -funroll-loops -o lattice2D-Lea-improved lattice2D-Lea-improved.c -lm
