...
if __name__ == "__main__":
    # Example usage: scan all result directories in analysis folder
    analysis_base = "analysis"
    method = 'diff'  # or 'kernel'
    ...
    # Plot lambda
    plot_3d_surface(df, value_col='lambda', title='Lambda vs Rho and Amplitude', save_path=os.path.join(analysis_base, f'lambda_vs_rho_amplitude_{method}_{result_type}.png'))
    # Plot gamma
    plot_3d_surface(df, value_col='gamma', title='Gamma vs Rho and Amplitude', save_path=os.path.join(analysis_base, f'gamma_vs_rho_amplitude_{method}_{result_type}.png'))
